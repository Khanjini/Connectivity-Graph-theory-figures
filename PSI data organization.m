...
for k = 1:size(cho_good,2);
    ...
    addpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\psi\psi_theta_2s_FDR');
    l_name = sprintf('pertest_psi_%02d.mat',num);
    load(l_name);
    rmpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\psi\psi_theta_2s_FDR');
...
for k = 1:size(cho_good,2);
    ...
    addpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\psi\psi_theta_alpha_2s_FDR');
    l_name = sprintf('pertest_psi_%02d.mat',num);
    load(l_name);
    rmpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\psi\psi_theta_alpha_2s_FDR');
    
     mat = psi_mat_theta_alpha;
    mat(mat<0) = 0 ;
...
for k = 1:size(cho_good,2);
    ...
    addpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\psi\psi_beta_2s_FDR');
    l_name = sprintf('pertest_psi_%02d.mat',num);
    load(l_name);
    rmpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\psi\psi_beta_2s_FDR');
...
for k = 1:size(cho_good,2);
    ...
    addpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\psi\psi_gamma_2s_FDR');
    l_name = sprintf('pertest_psi_%02d.mat',num);
    load(l_name);
    rmpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\psi\psi_gamma_2s_FDR');
    
     mat = psi_mat_gamma;
    mat(mat<0) = 0 ;
    
    good_CC_gamma_cho(1,k) = mean(clustering_coef_wd(mat));
    D = distance_wei(mat);
    good_CL_gamma_cho(1,k) = charpath(1./D);
    good_GE_gamma_cho(1,k) = efficiency_wei(mat);
    good_LE_gamma_cho(1,k) = mean(efficiency_wei(mat,2));
    good_str_gamma_cho(1,k) = mean(strengths_und(mat));
...
for k = 1:size(cho_bad,2);
    ...
    bad_CC_gamma_cho(1,k) = mean(clustering_coef_wd(mat));
    D = distance_wei(mat);
    bad_CL_gamma_cho(1,k) = charpath(1./D);
    bad_GE_gamma_cho(1,k) = efficiency_wei(mat);
    bad_LE_gamma_cho(1,k) = mean(efficiency_wei(mat,2));
    bad_str_gamma_cho(1,k) = mean(strengths_und(mat));
 
end;

gf_mean_std_good_beta_cho = [mean(good_CC_gamma_cho),std(good_CC_gamma_cho),mean(good_CL_gamma_cho),std(good_CL_gamma_cho),mean(good_GE_gamma_cho),std(good_GE_gamma_cho),mean(good_LE_gamma_cho),std(good_LE_gamma_cho),mean(good_str_gamma_cho),std(good_str_gamma_cho)]
gf_mean_std_bad_beta_cho = [mean(bad_CC_gamma_cho),std(bad_CC_gamma_cho),mean(bad_CL_gamma_cho),std(bad_CL_gamma_cho),mean(bad_GE_gamma_cho),std(bad_GE_gamma_cho),mean(bad_LE_gamma_cho),std(bad_LE_gamma_cho),mean(bad_str_gamma_cho),std(bad_str_gamma_cho)]

gf_result_cho = [ranksum(good_CC_gamma_cho,bad_CC_gamma_cho),ranksum(good_CL_gamma_cho,bad_CL_gamma_cho),ranksum(good_GE_gamma_cho,bad_GE_gamma_cho),ranksum(good_LE_gamma_cho,bad_LE_gamma_cho),ranksum(good_str_gamma_cho,bad_str_gamma_cho)]
[h,p1] = ttest2(good_CC_gamma_cho,bad_CC_gamma_cho);
[h,p2] = ttest2(good_CL_gamma_cho,bad_CL_gamma_cho);
[h,p3] = ttest2(good_GE_gamma_cho,bad_GE_gamma_cho);
[h,p4] = ttest2(good_LE_gamma_cho,bad_LE_gamma_cho);
[h,p5] = ttest2(good_str_gamma_cho,bad_str_gamma_cho);
gf_tresult_cho = [p1,p2,p3,p4,p5]
