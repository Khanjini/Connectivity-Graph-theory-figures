...
for k = 1:size(cho_good,2);
    ...
    addpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\coh\coh_theta_2s_FDR');
    l_name = sprintf('pertest_coh_%02d.mat',num);
    load(l_name);
    rmpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\coh\coh_theta_2s_FDR');
...
for k = 1:size(cho_good,2);
    ...
    addpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\coh\coh_theta_alpha_2s_FDR');
    l_name = sprintf('pertest_coh_%02d.mat',num);
    load(l_name);
    rmpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\coh\coh_theta_alpha_2s_FDR');
    
     mat = coh_mat_theta_alpha;
...
for k = 1:size(cho_good,2);
    ...
    addpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\coh\coh_beta_2s_FDR');
    l_name = sprintf('pertest_coh_%02d.mat',num);
    load(l_name);
    rmpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\coh\coh_beta_2s_FDR');
...
for k = 1:size(cho_good,2);
    ...
    addpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\coh\coh_gamma_2s_FDR');
    l_name = sprintf('pertest_coh_%02d.mat',num);
    load(l_name);
    rmpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\coh\coh_gamma_2s_FDR');
...
title('Correlation: COH-Strength')
ylabel('Actual MI classification accuracy[%]')
xlabel('Strength')
