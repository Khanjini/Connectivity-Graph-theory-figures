...
for k = 1:size(cho_good,2);
    ...
    addpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\plv\plv_theta_2s_FDR');
    l_name = sprintf('pertest_plv_%02d.mat',num);
    load(l_name);
    rmpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\plv\plv_theta_2s_FDR');
...
for k = 1:size(cho_good,2);
    ...
    addpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\plv\plv_theta_alpha_2s_FDR');
    l_name = sprintf('pertest_plv_%02d.mat',num);
    load(l_name);
    rmpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\plv\plv_theta_alpha_2s_FDR');
    
     mat = plv_mat_theta_alpha;
...
for k = 1:size(cho_good,2);
    ...
    addpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\plv\plv_beta_2s_FDR');
    l_name = sprintf('pertest_plv_%02d.mat',num);
    load(l_name);
    rmpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\plv\plv_beta_2s_FDR');
...
for k = 1:size(cho_good,2);
    ...
    addpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\plv\plv_gamma');
    l_name = sprintf('pertest_plv_%02d.mat',num);
    load(l_name);
    rmpath('C:\Users\Biocomputing\Desktop\workplace\Ahn_2013\plv\plv_gamma');
...
title('Correlation: PLV-Strength')
ylabel('Actual MI classification accuracy[%]')
xlabel('Strength')
